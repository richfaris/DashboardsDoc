...
**Why it matters (Claims Manager):** The core view of where loss is coming from---by category, line, and type---so you can allocate resources, spot trends, and tell a clear story to leadership.
...
1.  **Top 10 Agencies by Gross Losses Paid**\
    ...
    **Why it matters (Claims Manager):** Quickly see which agencies drive the most paid loss---so you can balance workload, target training, or have data-backed conversations with underwriting and distribution.
...
2.  **Map of Gross Losses Incurred**\
    ...
    **Why it matters (Claims Manager):** Spot geographic hotspots for cat planning, staffing, and vendor placement---so you can allocate resources where loss is concentrated.

3.  **Top 10 Claims Counts**\
    Horizontal bar chart of insureds by number of claims. Supports drill down.\
    **Why it matters (Claims Manager):** Identifies high-frequency claimants---so you can prioritize fraud or severity reviews and explain loss drivers to leadership.

4.  **Top 10 Total Gross Losses Paid**\
    Horizontal bar chart of insureds by total gross losses paid. Supports drill down.\
    **Why it matters (Claims Manager):** Surfaces the insureds with the largest paid loss---so you can focus large-loss reviews and reserve adequacy checks.
...
**Why it matters (Claims Manager):** One place to answer "what happened on this claim?"---reserves, payments, reinsurance, and assignment---so you can support large-loss reviews, audits, and leadership questions without opening multiple screens.
...
**Why it matters (Claims Manager):** Hold vendors accountable---see which contractors and reps are on which claims and the associated financials, so you can manage workload, control leakage, and report on vendor performance.
